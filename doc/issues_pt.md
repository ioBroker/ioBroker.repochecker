...
- [E002 Nenhum `ioBroker.` encontrado no nome do repositório](#e002-nenhum-iobroker-encontrado-no-nome-do-repositrio)
...
## Issues
### [E0001] Não é possível analisar o `package.json`
#### Explanation
...
### [E0002] Nenhum `ioBroker.` encontrado no nome do repositório
#### Explanation
