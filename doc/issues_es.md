...
- [E002 No se encontró `ioBroker.` en el nombre del repositorio](#e002-no-se-encontr-iobroker-en-el-nombre-del-repositorio)
...
## Issues
### [E0001] No se puede analizar `package.json`
#### Explicación
...
### [E0002] No se encontró `ioBroker.` en el nombre del repositorio
#### Explicación
