...
- [E002 Geen `ioBroker.` gevonden in de naam van het repository](#e002-geen-iobroker-gevonden-in-de-naam-van-het-repository)
...
## Issues
### [E0001] Kan `package.json` niet parsen
#### Uitleg
...
### [E0002] Geen `ioBroker.` gevonden in de naam van het repository
#### Uitleg
