...
- [E002 Kein `ioBroker.` im Namen des Repository gefunden](#e002-kein-iobroker-im-namen-des-repository-gefunden)
...
## Issues
### [E0001] Kann `package.json` nicht parsen
#### Erklärung
...
### [E0002] Kein `ioBroker.` im Namen des Repository gefunden
#### Erklärung
