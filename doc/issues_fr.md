...
- [E002 Aucun `ioBroker.` trouvé dans le nom du référentiel](#e002-aucun-iobroker-trouv-dans-le-nom-du-rfrentiel)
...
## Issues
### [E0001] Impossible d'analyser `package.json`
#### Explication
...
### [E0002] Aucun `ioBroker.` trouvé dans le nom du référentiel
#### Explication
