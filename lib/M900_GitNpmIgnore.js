            ...
            if (!tooComplexToCheck) {
                ...
                if (!isIgnored) {
                    context.warnings.push(
                        '[W906] .commitinfo file found but not excluded by .gitignore, suggest adding it to .gitignore',
                    );
                }
            }
        }
