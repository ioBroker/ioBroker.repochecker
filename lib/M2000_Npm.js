    ...
    if (!body) {
        try {
            ...
            if (!body.includes('href="/~bluefox"') && body.includes('href="/~iobluefox"')) {
                context.errors.push(
                    `[E2001] Bluefox was not as collaborator on npm. Please execute in adapter directory: "npm owner add bluefox iobroker.${context.adapterName}" or invite him at npmjs.com`,
                );
            } else {
