...
function handleResponsiveError(context, msg) {
    if (responsiveErrorLimit) {
        ...
        if (responsiveErrorLimit === 0) {
            context.errors.push(
                `[E513] responsive check: maximum issues reached, please fix reported ones and recheck`,
            );
        }
    }
}
...
// [513] responsive check: maximum issues reached, please fix reported ones and recheck
