...
function chk_responsive(context, path, jsonConfig, component, opts) {
    ...
    if (jsonConfig.sm && jsonConfig.sm > ii) {
        handleResponsiveError(
            context,
            `[E5509] "sm" value (${jsonConfig.sm}) for ${component} greater then value for smaller displays`,
        );
    } else {
        ii = jsonConfig.sm;
    }
    if (jsonConfig.md && jsonConfig.md > ii) {
        handleResponsiveError(
            context,
            `[E5509] "md" value (${jsonConfig.md}) for ${component} greater then value for smaller displays`,
        );
    } else {
        ii = jsonConfig.md;
    }
    if (jsonConfig.lg && jsonConfig.lg > ii) {
        handleResponsiveError(
            context,
            `[E5509] "lg" value (${jsonConfig.lg}) for ${component} greater then value for smaller displays`,
        );
    } else {
        ii = jsonConfig.lg;
    }
    if (jsonConfig.xl && jsonConfig.xl > ii) {
        handleResponsiveError(
            context,
            `[E5509] "xl" value (${jsonConfig.xl}) for ${component} greater then value for smaller displays`,
        );
    }
}
