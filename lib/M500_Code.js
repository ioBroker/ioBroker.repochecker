...
async function checkCode(context) {
    ...
    const readFiles = [
        ...
        '/lib/tools.js', // check if lib/tools.js is used
    ];
        ...
        if (compareVersions.compareVersions(version, '3.0.0') >= 0) {
            if (!context['/.releaseconfig.json']) {
                ...
                try {
                    ...
                    context.errors.push(`[E531] .releaseconfig.json is no valid json file - ${e}.`);
                }
            }
        }
    }
    ...
    if (context.filesList.includes('/lib/tools.js')) {
        ...
        if (!isUsed) {
            context.warnings.push(
                '[W530] "lib/tools.js" found in repo but not used anywhere. Consider removing this outdated file.',
            );
        }
    }
...
// [530] "lib/tools.js" found in repo but not used anywhere. Consider removing this outdated file.
// [531] .releaseconfig.json is no valid json file - ${e}.
