        ...
        */
        ...
        for (const entry of findIgnoredTrackedEntries(trackedEntries, rules)) {
            if (entry.path === '/build' && entry.isDirectory) {
                context.errors.push(
                    '[E9007] build directory is tracked but excluded by .gitignore. Either remove /build from git (if generated) or remove the ignore rule (if intentionally tracked).',
                );
                continue;
            }
