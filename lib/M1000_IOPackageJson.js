...
// [1103] Encryption of array elements "${key}" is not yet available (protectedNative-only dot keys; encryptedNative dot keys require js-controller >= 7.0.7 and trigger E1057)
