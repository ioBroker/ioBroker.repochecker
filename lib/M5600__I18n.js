...
function checkJsonConfigTranslations(context, configFile, jsonConfig, i18nDir, w5612State) {
    ...
    if (i18nMode === undefined || i18nMode === null) {
        context.warnings.push(
            `[W5619] "${displayConfig}" does not specify the "i18n" attribute. It defaults to true, which may be unintentional. Please explicitly add "i18n": true, "i18n": false, or a custom path.`,
        );
        return;
    }
