 ...
 * @param {{insideSelectOptions: boolean}} [state] - recursion state
 * @returns {Array<{attr: string, value: any, path: string, noTranslation: boolean, isSelectOptionLabel: boolean}>} - Collected attribute entries. isSelectOptionLabel is true for label attributes found inside select* options.
 */
