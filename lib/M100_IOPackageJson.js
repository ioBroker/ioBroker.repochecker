...
const blacklistIOPackageJson = {
    $schema: {
        msg: 'Please remove "$schema" from io-pacgae.json. You may set schema at your IDE to add edit-support.',
        err: true,
    },
    installedFrom: {
                ...
                for (const condition in blacklistIOPackageJson[blacklist].condition) {
                    ...
                    if (condition === 'onlyWWW') {
                        ...
                        if (onlyWWW !== blacklistIOPackageJson[blacklist].condition[condition]) {
                            // common.log(`    check failed`);
                            // common.log(`    ${context.ioPackageJson.common.onlyWWW}`);
                            // common.log(`    ${onlyWWW}`);
                            // common.log(`    ${blacklistIOPackageJson[blacklist].condition[condition]}`);
                            tmp = undefined;
                        }
                    }
                }
