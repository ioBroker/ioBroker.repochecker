            ...
            batch.map(async checkItem => {
                ...
                try {
                    ...
                    context.warnings.push(
                        `[${issueCode}] A newer version (${latestVersion}) for package "${packageName}" (${sourceType}) exists for ${packageAgeDays} ${dayLabel}. Please evaluate if upgrading from  ${packageVersion} to ${latestVersion} is possible.`,
                    );
                } catch (e) {
                    common.debug(
