    ...
    if (!context.hasExampleConfigWarning) {
        ...
        if (foundI18nKeys.size) {
            ...
            context.warnings.push(
                `[W5041] Example configuration (${keyList}) found in i18n translation files (languages: ${langList}). Please remove example configuration from your code.`,
            );
            context.hasExampleConfigWarning = true;
        }
    }
...
// [W5041] Example configuration (option1/option2) found in i18n translation files (languages: en, de, ...). Please remove example configuration from your code. (renamed from W1111)
