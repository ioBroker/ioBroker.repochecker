...
async function checkCode(context) {
    ...
    for (const filePath of Object.keys(context)) {
        ...
        const isInExcludedSourceRootDir = excludedSourceRootDirs.some(
            excludedDir => filePath === excludedDir || filePath.startsWith(`${excludedDir}/`),
        );
