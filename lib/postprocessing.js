...
const filterByAdapter = {
    ...
    backitup: [
        ...
        '[W8905] Repository contains package.json files in non-root directories *',
        '[W1144] Untranslated "common.news" entries detected (identical to English text): de(4.0.1); pl(4.0.1).', // reduce disussions ...
    ],
