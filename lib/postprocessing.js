...
const mapSeverity4New = {
    ...
    S5004: 'W', // [S5004] Plain setInterval() found in source files (lib/legacy/states.js, lib/zbDeviceAvailability.js, ...). Please use this.setInterval() or adapter.setInterval() instead.
    S5005: 'W', // [S5005] Plain setTimeout() found in source files (lib/localConfig.js, lib/networkmap.js, ...). Please use this.setTimeout() or adapter.setTimeout() instead.
