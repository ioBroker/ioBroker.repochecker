    ...
    if (!data) {
        ...
        if (pos === -1) {
            ...
            if (readmeYear > year) {
                ...
                if (m) {
                    context.errors.push(
                        `[E607] Future year (${readmeYear}) found in copyright. Please use "Copyright (c) ${m[1]}-${year} ${getAuthor(context.packageJson.author)}" at README.md after ##License header`,
                    );
                } else {
                    context.errors.push(
                        `[E607] Future year (${readmeYear}) found in copyright. Please use "Copyright (c) ${year} ${getAuthor(context.packageJson.author)}"  at README.md after ##License header`,
                    );
                }
            } else if (!valid) {
                ...
                if (m) {
                    context.errors.push(
                        `[E605] No actual year found in copyright. Please add "Copyright (c) ${m[1]}-${year} ${getAuthor(context.packageJson.author)}"  at README.md after ##License header`,
                    );
                } else {
                    context.errors.push(
                        `[E605] No actual year found in copyright. Please add "Copyright (c) ${year} ${getAuthor(context.packageJson.author)}"  at README.md after ##License header`,
                    );
                }
            } else {
